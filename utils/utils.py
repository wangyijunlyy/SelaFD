...
def init(cfg):
    ...
    log_dir = f"{taskfolder}/{cfg.rank}_{cfg.train_type}_{cfg.data_path}_{datafmt}.log"
    initLogging(log_dir)
    ckpt_path = f"{taskfolder}/{cfg.rank}_{cfg.train_type}_{cfg.data_path}_{datafmt}.pt"
    return ckpt_path
